...
- `Batch A - 飞机终版收口`
  ...
  - [done] 玩家机已补强进气脊背过渡、内侧挂架封帽、腹部门板与尾段状态件；敌机已补强进气肩、机腹挂载整流罩、挂架肩部与尾段过渡 brace
- `Batch B - 战斗反馈终版收口`
...
- [active] 敌机结构真实化细节收口已继续推进
  ...
  - 已补强敌机进气肩整流罩、机腹挂载整流罩、挂架肩部与尾段 brace 过渡
  - 已继续压低敌机发光和灯件强度，统一到更克制的军机金属语言
  - 已补强玩家机座舱后肩、翼根过渡和外侧挂点支架
  - 已补强玩家机进气脊背过渡、内侧挂架封帽、腹部门板与尾段状态表现件
...
- [done] 第一关自然景观层次增强已完成
  ...
  - 增加湖岸/水面读边层次
- [done] 透明环境层深度策略已收口
  - 水面、云层、卷云、雾霾、天气与限定玩法 VFX / 尾迹统一回到普通透明深度排序
  - 策略要求 `renderOrder === 0`、开启 `depthTest`、关闭 `depthWrite`，避免环境透明层压住玩法透明效果
- [active] 五关环境精修终版
...
- [done] 命中反馈 profile 分流第二轮已完成
  - 玩家命中已进一步收口到短硬金属擦击，敌机命中更轻更暖，Boss/重武器命中补齐后摇层次
- [next] 重炮 / Boss 炮击特效升级
  - 更清楚的炮口 flash
  - 更清楚的弹道存在感
  - 命中后有更明确的冲击层次
